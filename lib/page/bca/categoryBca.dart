...
import 'package:quiz_app_ii_example/widget/bca/question_numbers_widget.dart';
import 'package:quiz_app_ii_example/widget/bca/questions_widget.dart';
...
class _CategoryPageState extends State<CategoryPage> {
  ...
  Widget buildAppBar(context) => AppBar(
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                const Color(0xFF6457ff),
                const Color(0xFF4b3fdf),
              ],
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: QuestionNumbersWidgetBcom(
  ...
  void selectOption(OptionBca option) {
