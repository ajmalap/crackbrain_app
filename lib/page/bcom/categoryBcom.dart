...
import 'package:quiz_app_ii_example/widget/bcom/question_numbers_widget.dart';
// import 'package:quiz_app_ii_example/widget/bcom/question_numbers_widget.dart';
// import 'package:quiz_app_ii_example/widget/bcom/question_numbers_widget.dart';
// import 'package:quiz_app_ii_example/widget/bcom/question_numbers_widget.dart';
import 'package:quiz_app_ii_example/widget/bcom/questions_widget.dart';
...
class _CategoryPageState extends State<CategoryPage> {
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                const Color(0xFF9e57ff),
                const Color(0xFF7234c6),
              ],
  ...
  void selectOption(OptionBcom option) {
